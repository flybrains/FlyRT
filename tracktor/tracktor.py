...
def detect_and_draw_contours(frame, thresh, meas_last, meas_now, p2a_thresh):
    """
...
def reorder_and_draw(final, colours, n_inds, col_ind, meas_now, df, mot, fr_no, draw_circles=False):
    """
    ...
    if equal == False:
        ...
        meas_now = [x for (y,x) in sorted(zip(reordered,meas_now[:2]))]
